...
public class I_SJF extends AppCompatActivity {
           ...
           /* int k=0;
            ...
            while(k==0 || count<=1) {
                try {
                    ...
                    for (int i = 0; i < ta.size(); i++) {
                        for (int j = i + 1; j < ta.size(); j++) {
                            if (ta.get(i).equals(ta.get(j)) && te.get(i).equals(te.get(j))) {
                                if (queue.get(i) > queue.get(j)) {
                                    int temp = ta.get(i);
                                    int temp1 = queue.get(i);
                                    int temp2 = te.get(i);
                    ...
                    for (int i = 0; i < aarray.size(); i++) {
                        if (ids.get(i).equals(queue.get(0))) {
                            ...
                            if(cou.get(ids.get(i))==1) {
                                fe.add(te.get(0)-earray1.get(i));
                            }
                            else{
                                fe.add(te.get(0)-earray.get(i));
                            }
                            previous = i;
                            g++;
                            break;
                    ...
                    try {
                        if(cou.get(ids.get(l))==1){
                            counter += te.get(0)-earray1.get(l);
