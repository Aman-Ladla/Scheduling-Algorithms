...
public class I_Priority extends AppCompatActivity {
    ...
    public void remove(View view){
        if(row>=3) {
            ...
            editText[row - 2][4].setVisibility(View.GONE);
            row--;
        }
        else{
    ...
    public void animate(View view){
        ...
        EditText e4 = findViewById(R.id.editText26);
        e0.setTag("0");
        e2.setTag("0");
        e3.setTag("0");
        ...
        if(!String.valueOf(e0.getText()).equals("") &&  !String.valueOf(e1.getText()).equals("") &&
                !String.valueOf(e2.getText()).equals("") && !String.valueOf(e3.getText()).equals("") && !String.valueOf(e4.getText()).equals("")) {
            c=0;
            ...
            parray.add(Integer.valueOf(String.valueOf(e4.getText())));
        ...
        for(int j=1;j<row-1;j++){
            if(!String.valueOf((editText[j][1]).getText()).equals("") && !String.valueOf((editText[j][0]).getText()).equals("")
                    && !String.valueOf(editText[j][2].getText()).equals("") && !String.valueOf(editText[j][3].getText()).equals("") && !String.valueOf(editText[j][4].getText()).equals("")) {
                d=0;
                ...
                parray.add(Integer.valueOf(String.valueOf((editText[j][4]).getText())));
        ...
        if(c==0 && d==0 && f==0) {
            ...
            for(int i=1;i<aarray.size();i++) {
                for (int j = i + 1; j < aarray.size(); j++) {
                    if (aarray.get(i).equals(aarray.get(j)) && parray.get(i).equals(parray.get(j))) {
            ...
            Log.i("Ascended parray",parray.toString());
            ...
            while(k==0 || count<=1) {
                try {
                    ...
                    if(previous<=row-1) {
                        if (m == 0) {
                            if (flag.get(previous)) {
                                ...
                                parray.add(parray.get(previous));
                    ...
                    for (int i = 0; i < ta.size(); i++) {
                        for (int j = i + 1; j < ta.size(); j++) {
                            if (ta.get(i).equals(ta.get(j)) && tp.get(i).equals(tp.get(j))) {
                                if (queue.get(i) > queue.get(j)) {
                                    int temp = ta.get(i);
                                    int temp1 = queue.get(i);
                                    int temp2 = te.get(i);
                    ...
                    for(int i=0;i<aarray.size();i++){
                        for(int j=i+1;j<aarray.size();j++){
                            if(i==l && ids.get(i).equals(ids.get(j))){
                                if (end0.get(j)) {
                                    end.set(j, true);
                                }
                            }
                    ...
                    try {
                        counter += te.get(0);
                        if(cou.get(ids.get(l))==1){
                            IOI.set(ids.get(l),counter);
                            IOF.set(ids.get(l),counter+iarray.get(l));
                            IOT.set(ids.get(l),tarray.get(l));
                        }
                        else{
                            carray.set(ids.get(l),counter);
                        }
                    } catch (Exception e) {
                        counter++;
                    }
    ...
    public void add(View view){
        ...
        if(row==3){
            ...
            editText[1][4] = findViewById(R.id.editText36);
            ...
            editText[1][4].setVisibility(View.VISIBLE);
        ...
        if(row==4){
            ...
            editText[2][4] = findViewById(R.id.editText46);
            ...
            editText[2][4].setVisibility(View.VISIBLE);
        ...
        if(row==5){
            ...
            editText[3][4] = findViewById(R.id.editText56);
            ...
            editText[3][4].setVisibility(View.VISIBLE);
        ...
        if(row==6){
            ...
            editText[4][4] = findViewById(R.id.editText66);
            ...
            editText[4][4].setVisibility(View.VISIBLE);
        ...
        if(row==7){
            ...
            editText[5][4] = findViewById(R.id.editText76);
            ...
            editText[5][4].setVisibility(View.VISIBLE);
        ...
        if(row==8){
            ...
            editText[6][4] = findViewById(R.id.editText86);
            ...
            editText[6][4].setVisibility(View.VISIBLE);
        ...
        if(row==9){
            ...
            editText[7][4] = findViewById(R.id.editText96);
            ...
            editText[7][4].setVisibility(View.VISIBLE);
        ...
        if(row==10){
            ...
            editText[8][4] = findViewById(R.id.editText106);
            ...
            editText[8][4].setVisibility(View.VISIBLE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__priority);
        editText = new EditText[10][5];
