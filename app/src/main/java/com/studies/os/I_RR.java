...
public class I_RR extends AppCompatActivity {
        ...
        if(c==0 && d==0 && f==0 && z==1) {
            ...
            while(k==0 || count<=1) {
                try {
                        ...
                        if (ids.get(i).equals(queue.get(0))) {
                            ...
                            if(cou.get(ids.get(i))==0){
                                if(earray.get(i)<=tq){
                                    ...
                                    if(cou.get(ids.get(i))==1){
                                        IOI.set(ids.get(i),counter);
                                        IOF.set(ids.get(i),counter+iarray.get(i));
                                ...
                                if(earray1.get(i)<=tq){
                                    ...
                                    earray1.set(i,0);
                                    cou.set(ids.get(i),cou.get(ids.get(i))+1);
                                    if(cou.get(ids.get(i))==2) {
                                        carray.set(ids.get(i), counter);
                                    }
                                }
                                else{
                                    counter0=counter;
                                    ...
                                    fe.add(tq);
                                    earray1.set(i,earray1.get(i)-tq);
                                }
                            }
                            previous = i;
                            g++;
                    ...
                    if(previous<=row-1 && cou.get(ids.get(l))==1) {
                        if (m == 0) {
                    ...
                    if(counter0==6 || (counter0==20 && counter==21)){
                    e.printStackTrace();}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__r_r);
